...
def main():
    ...
    os.system("cls")
    print()
    print(f"{DPURPLE}{BOLD}             _____  _   _ ______   ______  _____ {RESET}")
    print(f"{DPURPLE}{BOLD}            /  ___|| | | || ___ \\ / ___\\ \\/ / _ \\{RESET}")
    print(f"{PURPLE}{BOLD}            \\ `--. | |_| ||  __/| |     >  <  __/{RESET}")
    print(f"{PURPLE}{BOLD}             `--. \\|  _  || |   | |___/ /\\ \\| |  {RESET}")
    print(f"{LPURPLE}{BOLD}            /\\__/ /| | | || |    \\____|/_/\\_\\_|  {RESET}")
    print(f"{LPURPLE}{BOLD}            \\____/ \\_| |_/\\_|    \\____/     \\_/  {RESET}")
    print()
    print(f"{GRAY}   -----------------------------------------------------------{RESET}")
    print()
